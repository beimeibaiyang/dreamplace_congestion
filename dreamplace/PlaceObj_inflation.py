...
import dreamplace.MomentumInflation as momentum_inflation
...
class PlaceObj(nn.Module):
    ...
    def __init__(self, density_weight, params, placedb, data_collections,
        ...
        if params.routability_opt_flag:
            ...
            if params.enable_momentum_cell_inflation:
                self.op_collections.momentum_inflation_op = self.build_momentum_inflation(
                    params, placedb, self.data_collections)
                self.op_collections.inflation_stats_op = lambda: self.op_collections.momentum_inflation_op.stats()
    ...
    def build_momentum_inflation(self, params, placedb, data_collections):
        """
        @brief build momentum-based cell inflation op
        """
        return momentum_inflation.MomentumInflation(params, placedb, data_collections)
